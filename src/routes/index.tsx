  ...
  head: () => ({
    meta: [
      { title: "NI — Nan Idhini · AI Mental Wellness Support" },
      {
        name: "description",
        content:
          "Open-access AI wellness support. Describe how you feel. Receive a calm, NLP-driven response and solo self-calming steps. No login.",
      },
        ...
        <div className="mx-auto max-w-6xl px-6 pt-20 pb-24 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
              NI (Nan Idhini) is an AI-based mental wellness support system. Describe how you feel —
              NLP and machine learning identify your emotional state, estimate stress, and respond
              with calm solo self-care steps you can do alone.
            </p>
            <div className="mt-10 flex items-center gap-3">
              ...
              <Link
                to="/about"
                className="px-5 py-3 text-xs tracking-[0.25em] uppercase text-muted-foreground hover:text-foreground transition"
              >
                How it works
              </Link>
            </div>
            <p className="mt-8 text-xs text-muted-foreground max-w-md">
              Supportive guidance only. NI is not a diagnosis, therapy replacement, or emergency
              service.
            </p>
          </div>
            ...
            <div className="border border-border bg-surface scanline relative">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="border border-border p-3 text-sm text-muted-foreground">
                  "Let's take this one breath at a time. Try a brain dump on paper for five
                  minutes."
                </div>
              </div>
            </div>
