  ...
  head: () => ({
    meta: [
      { title: "How NI works · System overview" },
      {
        name: "description",
        content:
          "How NI uses NLP, machine learning, and a safety layer to provide solo self-calming recommendations. Limits and ethical framing.",
      },
      { property: "og:title", content: "How NI works" },
      {
        property: "og:description",
        content: "NLP + ML + safety layer for emotional wellness support.",
      },
    ],
  }),
  component: About,
    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <Section title="Pipeline">
        <ol className="space-y-3 text-sm text-muted-foreground leading-relaxed">
          <Step n="1" t="Input">
            You describe how you feel in free text. No account, no log of identity.
          </Step>
          <Step n="2" t="Preprocessing">
            Text is normalized, tokenized, and cleaned before model inference.
          </Step>
          <Step n="3" t="Emotion classification">
            A multi-class model maps your text to one of: anxious, stressed, overwhelmed, sad,
            lonely, angry, exhausted, calm.
          </Step>
          <Step n="4" t="Stress scoring">
            Intensity is estimated as low, medium, or high with a confidence score.
          </Step>
          <Step n="5" t="Safety layer">
            A deterministic detector scans for crisis phrases. If found, normal flow is overridden
            with a safety response.
          </Step>
          <Step n="6" t="Solo recommendations">
            A mapping engine returns calm, low-risk, single-person actions you can try right now.
          </Step>
        </ol>
      </Section>
